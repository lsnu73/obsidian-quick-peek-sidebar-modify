...
## 1.5. How to Add a New Setting

Follow these steps to add a new setting to the plugin:

### 1.5.1. Add a new field to the settings interface
...
### 1.5.2. Add a default value in default settings
...
### 1.5.4. Add setting configuration to the layout
