import {App, Notice, Plugin, PluginSettingTab, Setting, WorkspaceRibbon, WorkspaceSplit} from "obsidian";
import {getDefaultLanguageCode, languageMap} from "./lang";
...
class SidebarHoverSettingsTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        new Setting(containerEl)
            .setName(currentLanguage.leftSidebarHover)
            .setDesc(
                currentLanguage.leftSidebarHoverDesc
            )
            .addToggle((t) =>
        ...
        // 右侧边栏悬停触发设置
        new Setting(containerEl)
            .setName(currentLanguage.rightSidebarHover)
            .setDesc(
                currentLanguage.rightSidebarHoverDesc
            )
            .addToggle((t) =>
                t
        ...
        // 同步左右侧边栏设置
        new Setting(containerEl)
            .setName(currentLanguage.syncLeftRightSidebar)
            .setDesc(
                currentLanguage.syncLeftRightSidebarDesc
            )
            .addToggle((t) =>
                t
        ...
        // 覆盖模式设置
        new Setting(containerEl)
            .setName(currentLanguage.overlayMode)
            .setDesc(
                currentLanguage.overlayModeDesc
            )
            .addToggle((t) =>
                t
        ...
        // 双击固定设置
        new Setting(containerEl)
            .setName(currentLanguage.doubleClickPin)
            .setDesc(
                currentLanguage.doubleClickPinDesc
            )
            .addToggle((t) =>
                t
        ...
        // 仅当聚焦时设置
        new Setting(containerEl)
            .setName(currentLanguage.onlyWhenFocused)
            .setDesc(
                currentLanguage.onlyWhenFocusedDesc
            )
            .addToggle((t) =>
                t
        ...
        // 行为部分标题
        new Setting(containerEl).setName(currentLanguage.behavior).setHeading();

        // 左侧边栏像素触发阈值设置
        new Setting(containerEl)
            .setName(currentLanguage.leftSidebarPixelTrigger)
            .setDesc(
                currentLanguage.leftSidebarPixelTriggerDesc
            )
            .addText((text) => {
                text
                    .setPlaceholder("30")
        ...
        // 右侧边栏像素触发阈值设置
        new Setting(containerEl)
            .setName(currentLanguage.rightSidebarPixelTrigger)
            .setDesc(
                currentLanguage.rightSidebarPixelTriggerDesc
            )
            .addText((text) => {
                text
                    .setPlaceholder("30")
        ...
        // 定时部分标题
        new Setting(containerEl).setName(currentLanguage.timing).setHeading();

        // 边栏延迟设置
        new Setting(containerEl)
            .setName(currentLanguage.sidebarDelay)
            .setDesc(
                currentLanguage.sidebarDelayDesc
            )
            .addText((text) => {
                text
                    .setPlaceholder("300")
        ...
        // 边栏展开延迟设置
        new Setting(containerEl)
            .setName(currentLanguage.sidebarExpandDelay)
            .setDesc(
                currentLanguage.sidebarExpandDelayDesc
            )
            .addText((text) => {
                text
                    .setPlaceholder("200")
        ...
        // 展开/折叠速度设置
        new Setting(containerEl)
            .setName(currentLanguage.expandCollapseSpeed)
            .setDesc(
                currentLanguage.expandCollapseSpeedDesc
            )
            .addText((text) => {
                text
                    .setPlaceholder("300")
        ...
        // 外观部分标题
        new Setting(containerEl).setName(currentLanguage.appearance).setHeading();
        // 语言切换
        new Setting(containerEl).setName(currentLanguage.language).addDropdown((component) => {
            languageMap.forEach((_value, key) => {
                component.addOption(key, key);
            })
            /*
                设置当前的语言，不要写死成"zh"或者任何硬编码
                因为你写死为"zh"，那么选择其他语言就不会生效，因为你都固定成了"zh"
            */
        ...
        // 左侧边栏最大宽度设置
        new Setting(containerEl)
            .setName(currentLanguage.leftSidebarMaxWidth)
            .setDesc(
                currentLanguage.leftSidebarMaxWidthDesc
            )
            .addText((text) => {
                text
                    .setPlaceholder("300")
        ...
        // 右侧边栏最大宽度设置
        new Setting(containerEl)
            .setName(currentLanguage.rightSidebarMaxWidth)
            .setDesc(
                currentLanguage.rightSidebarMaxWidthDesc
            )
            .addText((text) => {
                text
                    .setPlaceholder("300")
